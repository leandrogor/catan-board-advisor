...
export class ShortcutsHelpModalComponent {
  ...
  protected readonly phaseShortcuts = computed<ShortcutItem[]>(() => {
    ...
    return [
      ...
      { key: t.shortcutsInCards(2), label: t.shortcutsItemPlayRoadBuilding },
      { key: t.shortcutsInCards(3), label: t.shortcutsItemPlayYearOfPlenty },
      { key: t.shortcutsInCards(4), label: t.shortcutsItemPlayMonopoly },
      { key: t.shortcutsInCards(5), label: t.shortcutsItemPlayVP },
