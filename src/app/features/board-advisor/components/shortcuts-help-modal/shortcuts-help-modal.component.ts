...
export class ShortcutsHelpModalComponent {
  ...
  protected readonly phaseShortcuts = computed<ShortcutItem[]>(() => {
    ...
    return [
      ...
      { key: '1 (en menú)', label: t.shortcutsItemBuildRoad },
      { key: '2 (en menú)', label: t.shortcutsItemBuildSettlement },
      { key: '3 (en menú)', label: t.shortcutsItemBuildCity },
      { key: '4 (en menú)', label: t.shortcutsItemBuyDevCard },
      { key: '5 (en menú)', label: t.shortcutsItemOpenPlayCardSubmenu },
      { key: '1 (en cartas)', label: t.shortcutsItemPlayKnight },
      { key: '2 (en cartas)', label: t.shortcutsItemPlayVP },
      { key: '3 (en cartas)', label: t.shortcutsItemPlayMonopoly },
      { key: '4 (en cartas)', label: t.shortcutsItemPlayRoadBuilding },
      { key: '5 (en cartas)', label: t.shortcutsItemPlayYearOfPlenty },
